...
# import pickle
# from nicpy_definitions import DATA_PERSIST_DIRECTORY
#
#
# class CacheDict:
#
#     def __init__(self, func, persist_directory=DATA_PERSIST_DIRECTORY, persist_filename = None, initial_keys=(), persist_lifetime_hours=10**10):
#
#         self.func = func
